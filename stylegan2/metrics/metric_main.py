...
def pr1k3_full(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    precision, recall = precision_recall.compute_pr(opts, max_real=200000, num_gen=1000, nhood_size=3, row_batch_size=10000, col_batch_size=10000)
    return dict(pr1k3_full_precision=precision, pr1k3_full_recall=recall)
